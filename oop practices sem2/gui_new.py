...
class Main_Screen(Tk, Frame):
    ...
    def lend_id(self):
        ...
        self.e3.pack()
        Label(self.s2, text='',  bg='cadet blue').pack()
        Button(self.s2, text='price', bg='turquoise',fg='black', font=("Calibri", 10, "bold"), bd=6, height='2', width="30", command=self.price).pack()
        Label(self.s2, text='',  bg='cadet blue').pack()
        Button(self.s2, text='lend', bg='turquoise',fg='black', font=("Calibri", 10, "bold"), bd=6, height="2", width="30", command=self.lend_book).pack()
        self.day = self.date()  ## just assume that user placed order today and after that i correct it
        self.x = self.day.due_day
        Label(self.s2, text='',  bg='cadet blue').pack()
