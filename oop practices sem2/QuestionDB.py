...
class QuestionDB:
    ...
    def saveQuestionList(self):
        f = open('C:/Users/maria/AppData/Local/Programs/Python/Python37-32/Quiz Game/QuestionsDB.txt', 'w')
    ...
    def loadQuestionList(self):
        self.questionList = []
        try:
            f = open('C:/Users/maria/AppData/Local/Programs/Python/Python37-32/Quiz Game/QuestionsDB.txt', 'r')
        except:
            return
        for line in f:
            question = eval(line)
