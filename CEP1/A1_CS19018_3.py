...
from A1_CS19018_1 import date, Person, BookItem
from A1_CS19018_2 import *
...
class User:#this class is used to maintain the user log
    ...
    def USER_LOG(self,n='user_login'):#passing the file as a parameter
        ...
        with open(self.n, 'r') as f:#this statement is used to open the file
            x = len(f.readlines())#reads the lines of the file and returns its len
            f.seek(0)
            for i in range(x):
                v = f.readline()
...
class Main_Screen(Tk, Frame):#this class is used to create all the custom functionality and place it on the screen
    def __init__(self):
        super().__init__()
        self.date = date #calling the date class and passing it as the value to an instance
        self.Book = BookItem.book #calling the book item class and passing it as a value to an instance
        ...
        Button(self.screen, text="Maintain Log", width='20', height='2',fg='black', font=("Calibri", 10, "bold"), bd=6, bg='PaleGreen3',command = self.Maintain_USerLog).pack()
        # this button is used to destroy the screen that displays the custom functionality
        Button(self.screen, text="Exit", width='20', height='2',fg='black', font=("Calibri", 10, "bold"), bd=6, bg='PaleGreen3',command = self.destroy).pack()
    ...
    def LIBRARY_INFO(self):
        self.s1 = Toplevel(self.screen)#used to place anything at the top of the screen
    ...
    def Check_Fine(self):#this function checks whether fine is applicable but does it in a gui format,
    ...
    def check_fine(self):#this function is used to place all the features regarding the fine issued on the screen
        ...
        y = self.e7.get()#e7 here represents the entries that we have made till now to be displayed on the screen,
        # this enytry checks if the user has lend a book or not
        l = User.d[self.idd]#recalls if any book is lended by using the id of the user as refrence,
        ...
        try:
            ...
            Label(self.s3, text='First lend the book sorry!!!', height="3", font=("Calibri", 10, "bold"),bg='cadet blue').pack()
    ...
    def fine(self):#checks for the fine and is directly related to the date class
        ...
        try:
            ...
            Label(self.s3, text = 'Sorry!!! check your input', height="3", font=("Calibri", 10, "bold"), bg='cadet blue').pack()
    ...
    def return_book(self):#used to take the id as input and then checks if any book has been lended or not
        Label(self.s3, text="",  bg='cadet blue').pack()
    ...
    def returnb(self):#takes the name of the book that the user wants to return ad input and also is used to put the gui widgets on the screen
        ...
        try:
            if self.idd in self.a.d:
                ...
                print(len(x))
                if len(x) == 1:
                    Label(self.s3, text='Before Exit , kindly maintain your log first after lend any book ', height="3", font=("Calibri", 10, "bold"), bg='cadet blue').pack()
                    Label(self.s3, text='So that you can return the book', height="3", font=("Calibri", 10, "bold"), bg='cadet blue').pack()
                    Label(self.s3, text='where you can see either you lend any book or not', height="3", font=("Calibri", 10, "bold"), bg='cadet blue').pack()
                else:
                ...
                print(x)
                if len(x) == 1:
                    Label(self.s3, text='Before Exit , kindly maintain your log first , so that you can return the book ', height="3", font=("Calibri", 10, "bold"), bg='cadet blue').pack()
            ...
            Label(self.s3, text='Invalid Input',  height="3", font=("Calibri", 10, "bold"), bg='cadet blue').pack()
    ...
    def book_reserve(self):#this function is used to display all the gui widgets related to reserving books on the main screen
    ...
    def fetch_reservation_detail(self):#this function is used to display all the gui widgets regarding reservation on the screen
    ...
    def fetch_reservation_details(self):
        ...
        Label(self.s6, text="", bg='cadet blue').pack()
        re = str(self.e6.get())
        from A1_CS19018_1 import BookReservation
        if re not in BookItem.book:
            ...
            Label(self.s6, text='We have this book in our library, so you can lend it whenever you want', height="3", font=("Calibri", 10, "bold"), bg='cadet blue').pack()
    ...
    def payment(self):#this function is used to display all the gui labels and buttons on the screen
        ...
        Label(self.s8, text="PAYMENT", bg='cadet blue', width="300", height="3", font=("Bodoni MT Black", 13)).pack()
    ...
    def paycheck1(self):#this function is used to take the payment of the book reserved,added
        ...
        try:
            if self.ci in self.a.d:
                ...
                print(len(xi))
                if len(xi) <= 1:
                    Label(self.s8, text="You dont take any book , so why you want to pay", bg='cadet blue').pack()
                else:
                    x = self.a.d[self.ci]
                    Label(self.s8, text=f'You have to pay for {x[1:]}', bg='cadet blue').pack()
    ...
    def paycheck(self):#this function is used to display the label on the screen that the amount charged has been paied
        ...
        try:
            if len(self.a.d[self.ci]) <= 1:
                Label(self.s8, text='Zero amount deducted', height="3", font=("Calibri", 10, "bold"), bg='cadet blue').pack()

            elif self.Ac.isdigit():
                Label(self.s8, text='Amount is paid', height="3", font=("Calibri", 10, "bold"), bg='cadet blue').pack()
                Label(self.s8, text='Thank you come again', height="3", font=("Calibri", 10, "bold"), bg='cadet blue').pack()
            else:
                Label(self.s8, text='Invalid Account No', height="3", font=("Calibri", 10, "bold"), bg='cadet blue').pack()
        except:
            Label(self.s8, text='sorry some payment error', height="3", font=("Calibri", 10, "bold"), bg='cadet blue').pack()
    ...
    def displaybook(self):#this function is used to display the information and names of the book on the screen
        self.s6 = Toplevel(self.screen)
        self.s6.geometry("600x600")
